//
//  LyfeRadioButton.swift
//  lyfe
//
//  Created by Paul Escarcena on 5/28/18.
//  Copyright © 2018 Paul Escarcena. All rights reserved.
//

import UIKit

@IBDesignable
class LyfeRadioButton: UIControl {

    let titleLabel = UILabel()
    @IBInspectable var title: String = "pe" {
        didSet {
